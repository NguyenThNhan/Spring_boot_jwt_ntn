package com.example.spring_boot_jwt_ntn.util;
...
public class JwtUtil {
    ...
    private static final String USER = "nhan";
    private static final String SECRET = "This is my secret key cua nhan jfklsadjfaksdhfihf " +
            "jsdhfskjfsadhf kjadsklfjdksl ksadjfkldsj ksadjfk";
